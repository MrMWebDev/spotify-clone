  ...
  <div>
    <div
      ...
      <div class="flex items-center ml-6">
        ...
        <button type="button" class="rounded-full bg-black p-[1] ml-4 cursor-pointer">
      ...
      <button :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          <img class="rounded-full" width="30"
            src="https://yt3.ggpht.com/yti/AHXOFjUCdavN6ZuliRTXp2hulpNM6KB0qAiX33qpmxqigzE=s88-c-k-c0x00ffffff-no-rj-mo">
          <div class="text-white text-[14px] ml-1.5 font-semibold">MrMWebDev</div>
