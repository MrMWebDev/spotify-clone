...
<template>
    <li class="flex items-center justify-between rounded-md hover:bg-[#2A2929]" @mouseenter="isHovered = true"
        @mouseleave="isHovered = false">
        <div class="flex items-center w-full py-1.5">
            <div v-if="isHovered" class="w-[40px] ml-[14px] mr-[6px] cursor-pointer">
                ...
                <Pause v-else fillColor="#ffffff" :size="25" @click="useSong.playOrPauseThisSong()" />
            </div>
        ...
        <div class="flex items-center">
            <button type="button" v-if="isHovered">
